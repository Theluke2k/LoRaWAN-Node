...
static void ProcessRadioTxDone( void )
{
    ...
    TimerSetValue( &MacCtx.RxWindowTimer1, MacCtx.RxWindow1Delay - offset - 25); // DEBUG (default: MacCtx.RxWindow1Delay - offset) (-15 worked before)
...
static void OnRetransmitTimeoutTimerEvent( void* context )
{
	printf("OnRetransmitTimeoutTimerEvent\n");
...
LoRaMacStatus_t SendReJoinReq( JoinReqIdentifier_t joinReqType )
{
    ...
    switch( joinReqType )
    {
        ...
        case JOIN_REQ:
        {
             ...
             * Lucas (24-11-23):
             * Here we see that:
             * - The type of message to send is specified (join request)
             * - The buffer of data to send is specified (MacCtx.PktBuffer saved in JoinBuffer)
             * - The data buffer size is specified
             */
            ...
            /*
             * Lucas (24-11-23):
             * The join parameters are assigned here.
             */
...
static void OnRejoin0CycleTimerEvent( void* context )
{
	printf("OnRejoin0CycleTimerEvent\n");
...
static void OnRejoin1CycleTimerEvent( void* context )
{
	printf("OnRejoin1CycleTimerEvent\n");
...
static void OnForceRejoinReqCycleTimerEvent( void* context )
{
	printf("OnForceRejoinReqCycleTimerEvent\n");
