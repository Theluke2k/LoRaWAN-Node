...
#include "gpio.h"
//Should include "sx1276.h"? Might fix a lot of the lacking definitions
...
void SX1276IoInit( void )
{
    ...
    /*
     * LoRaMac wanted the last two pins, but the tdr board does not have these.
     * It is hard to say if it is a problem that they aren't initialized.
     */
...
void SX1276IoIrqDeInit()
{
	...
	GpioRemoveInterrupt( &SX1276.DIO2);
	GpioRemoveInterrupt( &SX1276.DIO3);
}
...
//Vent med at omskriv denne funktion til low power virker. RADIO_TCXO_POWER
...
/*
 * Lucas (12-11-23):
 * I dont really know what this Tcxo does. I think maybe that it
 * controls the power to the radio. But i dont know what the Tcxo pin is
 * on our tdr board. I dont even think that it is connected.
 */
...
/*
 * Lucas:
 * I saw that this function was not used anywhere so lets just comment it out for now.
 */
